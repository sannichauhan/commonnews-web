...
namespace com\cminds\popupfly\shared\classes;

use com\cminds\popupfly\CMPopUpBanners;

class CMPOPFLY_Labels
{
    const FILENAME = 'labels.tsv';
    const OPTION_LABEL_PREFIX = 'cmpopfly_label_';
    ...
    {
        return CMPopUpBanners::__(self::getLabel($labelKey));
    }
